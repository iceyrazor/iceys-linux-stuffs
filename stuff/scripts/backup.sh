...
exclude="--exclude manual-programs/OpenSeeFace --exclude **/minecraft/modpacks --exclude **/minecraft/servers --exclude **/iceys-linux-stuffs --exclude **/git --exclude **/local-server --exclude **/node_modules"
